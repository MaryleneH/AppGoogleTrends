...
# shiny::selectizeInput(inputId  = "search_terms",
#                       selected = default_list_terms,
#                       choices  = c("coronavirus", "covid19"),
#                       label    = "Les termes d'une requête",
#                       multiple = TRUE)
# 
#actionButton(inputId = "submit_search", label = "Lancer l'analyse ")
br()
br()
...
br()
br()
actionButton(inputId = "envoi_report", label = "Editer un reporting")
```


```{r}

#Lorsque l'on actionne le bouton : 'editer un reporting'
observeEvent(input$envoi_report, {
